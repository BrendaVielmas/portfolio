        ...
        <div id="menuSection" className="Menu">
          ...
          <div className="hexagon">
            <div className='one'>
              ...
              <a onClick={this.scrollToFunctionAbout}><div className='visibleDiv'><h1 className='componentName'>About</h1></div></a>
            </div>
            <div className='two'>
              <div className="skillsSec"><a onClick={this.scrollToFunctionSkills}><div className='visibleDiv'><h1 className='componentName'>Skills</h1></div></a></div>
              <div className='otherDiv'></div>
              <div className="projectsSec"><a onClick={this.scrollToFunctionProjects}><div className='visibleDiv'><h1 className='componentName'>Projects</h1></div></a></div>
            </div>
            <div className='three'>
              <a onClick={this.scrollToFunctionContact}><div className='visibleDiv contactDiv'><h1 className='componentName'>Contact</h1></div></a>
              <div className='otherDiv'></div>
            </div>
          </div>
        </div>
