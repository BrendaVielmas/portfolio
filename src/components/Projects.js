            ...
            <div className="flip-container">
              <div className="hexagon" >
                ...
                <div className="back"><h1>NOT-E:</h1> a very friendly app to save all your notes.
                  <div>
                    <div className="showHover demo"><a href="https://brendavielmas.github.io/Not-E/"><p>Demo</p></a></div>
                    <div className="showHover github"><a href="https://github.com/BrendaVielmas/Not-E"><p>Github</p></a></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="flip-container">
              <div className="hexagon">
                ...
                <div className="back"><h1>ECONIX:</h1> the best social network to change, buy or recommendate things about the ecology.
                  <div>
                    <div className="showHover demo"><a href="https://brendavielmas.github.io/Econix/src/"><p>Demo</p></a></div>
                    <div className="showHover github"><a href="https://github.com/BrendaVielmas/Econix"><p>Github</p></a></div>
                  </div>
                </div>
              </div>
            </div>
